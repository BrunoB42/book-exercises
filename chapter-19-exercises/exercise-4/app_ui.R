...
intro_panel <- tabPanel(
  ...
  img(src="inequality.png", alt="Example chart from NYT"),
  ...
  # text.
  p("This diagram shows that in the year 1980, the ", em("lowest")," income bracket of people were seeing the greatest growth in income. However now it is the ", strong("highest"), " income bracket now that sees the most growth")
)
